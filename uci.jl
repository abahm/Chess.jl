...
const log_filename = "uci_debug_log.txt"
    ...
    while true
        ...
        if contains(r, "debug")
            ...
            * debug [ on | off ]
            ...
            =#
            if contains(r, "debug off")
                uci_debug_mode = false
            end
            if contains(r, "debug on")
                uci_debug_mode = true
            end
        end

        if contains(r, "isready")
            #=
            * isready
