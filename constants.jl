...
NONE = UInt8(0)
KING, QUEEN, ROOK, BISHOP, KNIGHT, PAWN = UInt8(1),UInt8(2),UInt8(3),UInt8(4),UInt8(5),UInt8(6)
WHITE, BLACK = UInt8(1), UInt8(2)
A,B,C,D,E,F,G,H = UInt8(1),UInt8(2),UInt8(3),UInt8(4),UInt8(5),UInt8(6),UInt8(7),UInt8(8)
...
CASTLING_RIGHTS_ALL = CASTLING_RIGHTS_WHITE_ANYSIDE | CASTLING_RIGHTS_BLACK_ANYSIDE
